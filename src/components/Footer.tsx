      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
          <div className="md:col-span-5">
            <p className="font-serif text-xl font-bold tracking-tight mb-4">CarBuyingHub</p>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="mailto:dealers@carbuyinghub.com?subject=Partnership%20Inquiry" className={linkClass}>Become a Partner</a></li>
            </ul>
          </div>
          <div className="md:col-span-2">
